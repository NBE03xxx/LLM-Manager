...
_ENGLISH = {
    ...
    "restore_preview.approval_required": "Explicit restore approval is required. Restore is not connected.",
    "restore_preview.approved": "Approved for this exact preview. Restore is not connected.",
...
_JAPANESE = {
    ...
    "restore_preview.approval_required": "復元には明示承認が必要です。復元実行は未接続です。",
    "restore_preview.approved": "このプレビューを明示承認済みです。復元実行は未接続です。",
