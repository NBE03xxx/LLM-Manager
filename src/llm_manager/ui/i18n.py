...
_ENGLISH = {
    ...
    "action.run_sandbox_apply": "Run sandbox Apply",
    ...
    "results.sandbox_unavailable": "Apply execution is not connected in this build.",
...
_JAPANESE = {
    ...
    "action.run_sandbox_apply": "sandbox Applyを実行",
    ...
    "results.sandbox_unavailable": "このbuildではApply実行は接続されていません。",
