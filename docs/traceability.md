...
| Backup crypto/recovery | ADR-0009, threat model | `BackupCryptoTests`（AES-GCM/AAD/nonce/tamper/key scope/size）、Store・Approval・Secret Service・remote統合待ち | Phase 4一部完了 |
