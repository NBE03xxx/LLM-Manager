...
| SSH helper prerequisite | ADR-0008, version matrix | `HelperCompatibilityProbeTests`（fixed path、absent、symlink、root owner/mode、canonical package/version/protocol metadata）、remote package/SSH統合待ち | Phase 4一部完了 |
