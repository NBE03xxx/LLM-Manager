...
Ubuntu 26.04、Debian 13、Python 3.14.4、Python 3.14環境のPySide6 6.8.6以上、Ollama 0.33.2、OpenCode 1.18.25をbaselineとする。Debian 13 system Python 3.13/PySide6 6.8.2.1はOS提供の検証済み組合せとして別途許可する。D（診断）とA（自動変更）をfixture gateで分け、未知versionはR/read-onlyとする。
