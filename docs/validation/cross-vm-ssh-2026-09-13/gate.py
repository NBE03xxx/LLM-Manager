...
ROOT=Path('/tmp/phase6-cross-vm-20260913/evidence')
...
candidate=HostCandidate('ssh:phase6-cross-vm',HostKind.SSH,'Disposable Ubuntu SSH','phase6-cross-vm')
...
plan=OptimizationPlan('phase6-'+MODE,report.report_id,stable_hash(report),
    ...
    EncryptionInfo(True,'AES-256-GCM',1,'phase6-cross-vm-20260913','local_secret_service'))
