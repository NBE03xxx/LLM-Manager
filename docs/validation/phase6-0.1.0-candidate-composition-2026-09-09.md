...
`UNRELEASED`解除とrelease note更新は後続commitになるため、公開用の最終artifact setはそのcommitから再buildする。local candidateのpre-final lifecycle Gateは[Ubuntu](phase6-0.1.0-ubuntu-lifecycle-2026-09-09.md)と[Debian](phase6-0.1.0-debian-lifecycle-2026-09-09.md)で完了した。現在・次ともPhase 6。次はこのcandidateを使いresolved-environment SBOM、Qt license review、ログイン済みDebian実display/menuのGateを進める。
