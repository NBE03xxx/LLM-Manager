"""Prepare, inspect, and clean up the final Debian desktop-menu gate."""
from pathlib import Path


REPO = Path("/home/yoshimi/WorkSpace/LLM-Manager")
SOURCE = REPO / "docs/validation/debian-menu-ff7913b-2026-09-13.py"
replacements = {
    "debian-menu-ff7913b-2026-09-13": "debian-menu-final-2026-09-16",
    ...
    "/tmp/phase6-debian-menu-ff7913b-20260913.deb":
        "/tmp/phase6-debian-menu-final-20260916.deb",
