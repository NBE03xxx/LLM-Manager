...
RELAY_PATH='/tmp/phase6-final-ssh-commit-net4-20260917/hold/helper.py'
 ...
 def observe(self):
  ...
  if outcome is not None and not state.busy and self._active_host_id is None:
   ...
   result={'status':outcome.status.value,'error':outcome.error,
     ...
     'plan_injected':False,'approval_injected':False,'transport_injected':True,'transport_condition':'stdout relay and short keepalive; actual NIC cut', 'remote_sudo_timeout_seconds':600, 'remote_sudo_timeout_injected':True}
